        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://instagram.com/lawteckpecas" target="_blank" rel="noreferrer" aria-label="Instagram Lawteck Peças" className="bg-brand-blue-800 p-2 rounded hover:bg-brand-yellow-400 hover:text-brand-blue-900 transition-all">
                <Instagram size={20} />
              </a>
              <a href="https://tiktok.com/@lawteckpecas" target="_blank" rel="noreferrer" aria-label="TikTok Lawteck Peças" className="bg-brand-blue-800 p-2 rounded hover:bg-brand-yellow-400 hover:text-brand-blue-900 transition-all">
